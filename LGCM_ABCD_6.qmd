...
library(usethis)
use_git_config(user.name = "nattapatsima", user.email = "nattapat.sima@gmail.com")
...
# p, Internalizing, Externalizing plots
...
# annotate(geom = "text", x = 2.4, y = -0.6, label = 'paste(" ",italic("i"),"-",italic("s")," =  .004***   ")', parse=TRUE, size = 10)
```

#### semPath

```{r}
semPaths(readRDS("lg_g_4t_strong.rds"),
  whatLabels = "std",
  exoCov = FALSE,
  edge.label.cex = 1,
  edge.color = "black",
  what = "std",
  sizeMan2 = 3, sizeMan = 6,
  intercepts = F,
  rotation = 2,
  residuals = FALSE,
  layout = "tree3",
  ...
  residScale = 10,
  nodeLabels = c(
    "Flnk_10", "Patn_10", "Pic_10", "Voc_10", "Read_10",
    "Flnk_12", "Patn_12", "Pic_12", "Voc_12", "Read_12",
    "Flnk_14", "Patn_14", "Pic_14", "Voc_14", "Read_14",
    "Flnk_16", "Patn_16", "Pic_16", "Voc_16", "Read_16",
    "g_10", "g_12", "g_14", "g_16",
    "i_g", "s_g"
  )
)

semPaths(fit, what = "path", whatLabels = "std", style = "lisrel", edge.label.cex = .9, rotation = 2, curve = 2, layoutSplit = FALSE, normalize = FALSE, height = 9, width = 6.5, residScale = 10)
...
```{r}
g_layout_matrix <- matrix(NA, nrow = 10, ncol = 7)

# Left side: growth factors
g_layout_matrix[4, 1] <- "g_i"
g_layout_matrix[6, 1] <- "g_s"

# Middle: latent variables
g_layout_matrix[2, 4] <- "g_etaB"
g_layout_matrix[4, 4] <- "g_eta2"
g_layout_matrix[6, 4] <- "g_eta4"
g_layout_matrix[8, 4] <- "g_eta6"

# Right side: manifest variables — vertically stacked

# Time 0
g_layout_matrix[1, 7] <- "flanker_0"
g_layout_matrix[2, 7] <- "pattern_0"
g_layout_matrix[3, 7] <- "picture_0"
g_layout_matrix[4, 7] <- "picvocab_0"
g_layout_matrix[5, 7] <- "reading_0"

# Time 2
g_layout_matrix[1, 6] <- "flanker_2"
g_layout_matrix[2, 6] <- "pattern_2"
g_layout_matrix[3, 6] <- "picture_2"
g_layout_matrix[4, 6] <- "picvocab_2"
g_layout_matrix[5, 6] <- "reading_2"

# Time 4
g_layout_matrix[6, 6] <- "flanker_4"
g_layout_matrix[7, 6] <- "pattern_4"
g_layout_matrix[8, 6] <- "picture_4"
g_layout_matrix[9, 6] <- "picvocab_4"
g_layout_matrix[10, 6] <- "reading_4"

# Time 6
g_layout_matrix[6, 7] <- "flanker_6"
g_layout_matrix[7, 7] <- "pattern_6"
g_layout_matrix[8, 7] <- "picture_6"
g_layout_matrix[9, 7] <- "picvocab_6"
g_layout_matrix[10, 7] <- "reading_6"



semPaths(readRDS("lg_g_4t_strong.rds"),
  layout = g_layout_matrix,
...
# annotate(geom = "text", x = .9, y = -0.08, label = 'paste("  ",italic("i"),"-",italic("s")," = -.090***   ")', parse=TRUE, size = 10) +
# annotate(geom = "text", x = .9, y = -0.105, label = 'paste("  ",italic("i"),"-",italic("q")," =  .009*      ")', parse=TRUE, size = 10) +
# annotate(geom = "text", x = .9, y = -0.13, label = 'paste(" ",italic("s"),"-",italic("q")," = -.045***   ")', parse=TRUE, size = 10)
```
...
# annotate(geom = "text", x = .8, y = -0.035, label = 'paste("  ",italic("i"),"-",italic("s")," = -.175***   ")', parse=TRUE, size = 10) +
# annotate(geom = "text", x = .8, y = -0.055, label = 'paste("  ",italic("i"),"-",italic("q")," =  .023***   ")', parse=TRUE, size = 10) +
# annotate(geom = "text", x = .8, y = -0.075, label = 'paste(" ",italic("s"),"-",italic("q")," = -.080***   ")', parse=TRUE, size = 10)
```
...
# annotate(geom = "text", x = .8, y = 0.075, label = 'paste("  ",italic("i"),"-",italic("s")," = -.122***   ")', parse=TRUE, size = 10) +
# annotate(geom = "text", x = .8, y = 0.055, label = 'paste("  ",italic("i"),"-",italic("q")," =  .020***   ")', parse=TRUE, size = 10) +
# annotate(geom = "text", x = .8, y = 0.035, label = 'paste(" ",italic("s"),"-",italic("q")," = -.101***   ")', parse=TRUE, size = 10)
```
...
```{r}
lg.y.pub.model <- "# basis model
                      p_i =~ 1*ph_y_pds_mean_0 + 1*ph_y_pds_mean_1 + 1*ph_y_pds_mean_2 + 1*ph_y_pds_mean_3 + 1*ph_y_pds_mean_4 + 1*ph_y_pds_mean_5 + 1*ph_y_pds_mean_6
                      p_s =~ 0*ph_y_pds_mean_0 + .5*ph_y_pds_mean_1 + 1*ph_y_pds_mean_2 + 1.5*ph_y_pds_mean_3 + 2*ph_y_pds_mean_4 + 2.5*ph_y_pds_mean_5 + 3*ph_y_pds_mean_6
                      p_q =~ 0*ph_y_pds_mean_0 + .25*ph_y_pds_mean_1 + 1*ph_y_pds_mean_2 + 2.25*ph_y_pds_mean_3 + 4*ph_y_pds_mean_4 + 6.25*ph_y_pds_mean_5 + 9*ph_y_pds_mean_6
                      p_i~~NA*p_i
                      p_s~~NA*p_s
                      p_q~~NA*p_q
                      p_i~~p_s + p_q
                      ...
                      p_s~1
                      p_q~1
                      ph_y_pds_mean_0 ~~ NA*ph_y_pds_mean_0
                      ph_y_pds_mean_1 ~~ NA*ph_y_pds_mean_1
                      ph_y_pds_mean_2 ~~ NA*ph_y_pds_mean_2
                      ph_y_pds_mean_3 ~~ NA*ph_y_pds_mean_3
                      ph_y_pds_mean_4 ~~ NA*ph_y_pds_mean_4
                      ph_y_pds_mean_5 ~~ NA*ph_y_pds_mean_5
                      ph_y_pds_mean_6 ~~ NA*ph_y_pds_mean_6
                      ph_y_pds_mean_0 ~ 0*1
                      ph_y_pds_mean_1 ~ 0*1
                      ph_y_pds_mean_2 ~ 0*1
                      ph_y_pds_mean_3 ~ 0*1
...
lavaan(lg.y.pub.model,
  ...
  saveRDS("lgcm_y_pub_model.rds")
```

##### result

```{r}
eigen(inspect(readRDS("lgcm_y_pub_model.rds"), "cor.lv"))$value

readRDS("lgcm_y_pub_model.rds") %>%
  summary(
    std = T,
    fit.measures = TRUE,
    rsq = T
  ) %>%
  saveRDS("lgcm_y_pub_result.rds")

readRDS("lgcm_y_pub_result.rds")
```

#### Parent model

```{r}
lg.p.pub.model <- "# basis model
                      p_i =~ 1*ph_p_pds_mean_0 + 1*ph_p_pds_mean_1 + 1*ph_p_pds_mean_2 + 1*ph_p_pds_mean_3 + 1*ph_p_pds_mean_4 + 1*ph_p_pds_mean_5 + 1*ph_p_pds_mean_6
                      p_s =~ 0*ph_p_pds_mean_0 + .5*ph_p_pds_mean_1 + 1*ph_p_pds_mean_2 + 1.5*ph_p_pds_mean_3 + 2*ph_p_pds_mean_4 + 2.5*ph_p_pds_mean_5 + 3*ph_p_pds_mean_6
                      p_q =~ 0*ph_p_pds_mean_0 + .25*ph_p_pds_mean_1 + 1*ph_p_pds_mean_2 + 2.25*ph_p_pds_mean_3 + 4*ph_p_pds_mean_4 + 6.25*ph_p_pds_mean_5 + 9*ph_p_pds_mean_6
                      p_i~~NA*p_i
                      p_s~~NA*p_s
                      p_q~~NA*p_q
                      p_i~~p_s + p_q
                      ...
                      p_s~1
                      p_q~1
                      ph_p_pds_mean_0 ~~ NA*ph_p_pds_mean_0
                      ph_p_pds_mean_1 ~~ NA*ph_p_pds_mean_1
                      ph_p_pds_mean_2 ~~ NA*ph_p_pds_mean_2
                      ph_p_pds_mean_3 ~~ NA*ph_p_pds_mean_3
                      ph_p_pds_mean_4 ~~ NA*ph_p_pds_mean_4
                      ph_p_pds_mean_5 ~~ NA*ph_p_pds_mean_5
                      ph_p_pds_mean_6 ~~ NA*ph_p_pds_mean_6
                      ph_p_pds_mean_0 ~ 0*1
                      ph_p_pds_mean_1 ~ 0*1
                      ph_p_pds_mean_2 ~ 0*1
                      ph_p_pds_mean_3 ~ 0*1
...
lavaan(lg.p.pub.model,
  ...
  saveRDS("lgcm_p_pub_model.rds")
```

##### result

```{r}
eigen(inspect(readRDS("lgcm_p_pub_model.rds"), "cor.lv"))$value

readRDS("lgcm_p_pub_model.rds") %>%
  summary(
    std = T,
    fit.measures = TRUE,
    rsq = T
  ) %>%
  saveRDS("lgcm_p_pub_result.rds")

readRDS("lgcm_p_pub_result.rds")
```
...
lapply(
  c(
    "lgcm_y_pub_result.rds",
    "lgcm_p_pub_result.rds"
  ),
  function(f) {
    readRDS(f)$fit[c(
      "chisq", "df", "pvalue",
  ...
  do.call(rbind, .) %>%
  round(3) %>%
  data.frame(model = c("Youth", "Parent"), ., row.names = NULL)
```

### Latent growth curve model

#### Three neutral item model
...
#### Four item model (Gender-neutral + -specfic)
...
```{r}
pu.4i.config.invar <- "#factor loadings #
               pu_etaB =~ lambda_S*ph_p_pds_001_0+
                          lambda_R*ph_p_pds_002_0+
                          lambda_M*ph_p_pds_003_0+
                          lambda_F*ph_p_pds_mf_0
               pu_eta1 =~ lambda_S1*ph_p_pds_001_1+
                          lambda_R1*ph_p_pds_002_1+
                          lambda_M1*ph_p_pds_003_1+
                          lambda_F1*ph_p_pds_mf_1
               pu_eta2 =~ lambda_S2*ph_p_pds_001_2+
                          lambda_R2*ph_p_pds_002_2+
                          lambda_M2*ph_p_pds_003_2+
                          lambda_F2*ph_p_pds_mf_2
               pu_eta3 =~ lambda_S3*ph_p_pds_001_3+
                          lambda_R3*ph_p_pds_002_3+
                          lambda_M3*ph_p_pds_003_3+
                          lambda_F3*ph_p_pds_mf_3
               pu_eta4 =~ lambda_S4*ph_p_pds_001_4+
                          lambda_R4*ph_p_pds_002_4+
                          lambda_M4*ph_p_pds_003_4+
                          lambda_F4*ph_p_pds_mf_4
               pu_eta5 =~ lambda_S5*ph_p_pds_001_5+
                          lambda_R5*ph_p_pds_002_5+
                          lambda_M5*ph_p_pds_003_5+
                          lambda_F5*ph_p_pds_mf_5
               pu_eta6 =~ lambda_S6*ph_p_pds_001_6+
                          lambda_R6*ph_p_pds_002_6+
                          lambda_M6*ph_p_pds_003_6+
                          lambda_F6*ph_p_pds_mf_6
              ...
              #unique variances
                      ...
                      ph_p_pds_002_0~~ph_p_pds_002_0
                      ph_p_pds_003_0~~ph_p_pds_003_0
                      ph_p_pds_mf_0~~ph_p_pds_mf_0
                      ph_p_pds_001_1~~ph_p_pds_001_1
                      ph_p_pds_002_1~~ph_p_pds_002_1
                      ph_p_pds_003_1~~ph_p_pds_003_1
                      ph_p_pds_mf_1~~ph_p_pds_mf_1
                      ph_p_pds_001_2~~ph_p_pds_001_2
                      ph_p_pds_002_2~~ph_p_pds_002_2
                      ph_p_pds_003_2~~ph_p_pds_003_2
                      ph_p_pds_mf_2~~ph_p_pds_mf_2
                      ph_p_pds_001_3~~ph_p_pds_001_3
                      ph_p_pds_002_3~~ph_p_pds_002_3
                      ph_p_pds_003_3~~ph_p_pds_003_3
                      ph_p_pds_mf_3~~ph_p_pds_mf_3
                      ph_p_pds_001_4~~ph_p_pds_001_4
                      ph_p_pds_002_4~~ph_p_pds_002_4
                      ph_p_pds_003_4~~ph_p_pds_003_4
                      ph_p_pds_mf_4~~ph_p_pds_mf_4
                      ph_p_pds_001_5~~ph_p_pds_001_5
                      ph_p_pds_002_5~~ph_p_pds_002_5
                      ph_p_pds_003_5~~ph_p_pds_003_5
                      ph_p_pds_mf_5~~ph_p_pds_mf_5
                      ph_p_pds_001_6~~ph_p_pds_001_6
                      ph_p_pds_002_6~~ph_p_pds_002_6
                      ph_p_pds_003_6~~ph_p_pds_003_6
                      ph_p_pds_mf_6~~ph_p_pds_mf_6
              ...
              #unique covariances
                      ...
                      ph_p_pds_mf_0 ~~ ph_p_pds_mf_1 + ph_p_pds_mf_2 + ph_p_pds_mf_3 + ph_p_pds_mf_4 + ph_p_pds_mf_5 + ph_p_pds_mf_6
                      ph_p_pds_mf_1 ~~ ph_p_pds_mf_2 + ph_p_pds_mf_3 + ph_p_pds_mf_4 + ph_p_pds_mf_5 + ph_p_pds_mf_6
                      ph_p_pds_mf_2 ~~ ph_p_pds_mf_3 + ph_p_pds_mf_4 + ph_p_pds_mf_5 + ph_p_pds_mf_6
                      ph_p_pds_mf_3 ~~ ph_p_pds_mf_4 + ph_p_pds_mf_5 + ph_p_pds_mf_6
                      ph_p_pds_mf_4 ~~ ph_p_pds_mf_5 + ph_p_pds_mf_6
                      ph_p_pds_mf_5 ~~ ph_p_pds_mf_6
              ...
              #observed variable intercepts # S & S2
                      ...
                      ph_p_pds_002_0~tau_R*1
                      ph_p_pds_003_0~tau_M*1
                      ph_p_pds_mf_0~tau_F*1
                      ph_p_pds_001_1~tau_S1*1
                      ph_p_pds_002_1~tau_R1*1
                      ph_p_pds_003_1~tau_M1*1
                      ph_p_pds_mf_1~tau_F1*1
                      ph_p_pds_001_2~tau_S2*1
                      ph_p_pds_002_2~tau_R2*1
                      ph_p_pds_003_2~tau_M2*1
                      ph_p_pds_mf_2~tau_F2*1
                      ph_p_pds_001_3~tau_S3*1
                      ph_p_pds_002_3~tau_R3*1
                      ph_p_pds_003_3~tau_M3*1
                      ph_p_pds_mf_3~tau_F3*1
                      ph_p_pds_001_4~tau_S4*1
                      ph_p_pds_002_4~tau_R4*1
                      ph_p_pds_003_4~tau_M4*1
                      ph_p_pds_mf_4~tau_F4*1
                      ph_p_pds_001_5~tau_S5*1
                      ph_p_pds_002_5~tau_R5*1
                      ph_p_pds_003_5~tau_M5*1
                      ph_p_pds_mf_5~tau_F5*1
                      ph_p_pds_001_6~tau_S6*1
                      ph_p_pds_002_6~tau_R6*1
                      ph_p_pds_003_6~tau_M6*1
                      ph_p_pds_mf_6~tau_F6*1"

lavaan(pu.4i.config.invar,
  data = pub_yp_mean_wide.scaled,
  meanstructure = TRUE,
  estimator = "ML",
  missing = "fiml",
  ...
  saveRDS("p_4i_pub_config.rds")
```

###### result

```{r}
eigen(inspect(readRDS("p_4i_pub_config.rds"), "cor.lv"))$value

readRDS("p_4i_pub_config.rds") %>%
  summary(
    std = T,
    fit.measures = TRUE,
    rsq = T
  ) %>%
  saveRDS("p_4i_pub_config_result.rds")

readRDS("p_4i_pub_config_result.rds")
```
...
```{r}
pu.4i.weak.invar <- "#factor loadings - MARKER VARIABLE METHOD
               # First indicator (S) fixed to 1 at all time points for identification
               pu_etaB =~ 1*ph_p_pds_001_0+
                          lambda_R*ph_p_pds_002_0+
                          lambda_M*ph_p_pds_003_0+
               ...
               pu_eta1 =~ 1*ph_p_pds_001_1+
                          lambda_R*ph_p_pds_002_1+
                          lambda_M*ph_p_pds_003_1+
                          lambda_F*ph_p_pds_mf_1
               pu_eta2 =~ 1*ph_p_pds_001_2+
                          lambda_R*ph_p_pds_002_2+
                          lambda_M*ph_p_pds_003_2+
                          lambda_F*ph_p_pds_mf_2
               pu_eta3 =~ 1*ph_p_pds_001_3+
                          lambda_R*ph_p_pds_002_3+
                          lambda_M*ph_p_pds_003_3+
                          lambda_F*ph_p_pds_mf_3
               pu_eta4 =~ 1*ph_p_pds_001_4+
                          lambda_R*ph_p_pds_002_4+
                          lambda_M*ph_p_pds_003_4+
                          lambda_F*ph_p_pds_mf_4
               pu_eta5 =~ 1*ph_p_pds_001_5+
                          lambda_R*ph_p_pds_002_5+
                          lambda_M*ph_p_pds_003_5+
                          lambda_F*ph_p_pds_mf_5
               pu_eta6 =~ 1*ph_p_pds_001_6+
                          lambda_R*ph_p_pds_002_6+
                          lambda_M*ph_p_pds_003_6+
                          lambda_F*ph_p_pds_mf_6
...
lavaan(pu.4i.weak.invar,
  ...
  saveRDS("p_4i_pub_weak.rds")
```

###### result

```{r}
eigen(inspect(readRDS("p_4i_pub_weak.rds"), "cor.lv"))$value

readRDS("p_4i_pub_weak.rds") %>%
  summary(
    std = T,
    fit.measures = TRUE,
    rsq = T
  ) %>%
  saveRDS("p_4i_pub_weak_result.rds")

readRDS("p_4i_pub_weak_result.rds")
```
...
```{r}
pu.4i.strong.invar <- "#factor loadings - MARKER VARIABLE METHOD
               # First indicator (S) fixed to 1 at all time points for identification
               pu_etaB =~ 1*ph_p_pds_001_0+
                          lambda_R*ph_p_pds_002_0+
                          lambda_M*ph_p_pds_003_0+
              ...
              #observed variable intercepts - CONSTRAINED TO BE EQUAL ACROSS TIME
                      ...
                      ph_p_pds_002_1~tau_R*1
                      ph_p_pds_003_1~tau_M*1
                      ph_p_pds_mf_1~tau_F*1
                      ph_p_pds_001_2~tau_S*1
                      ph_p_pds_002_2~tau_R*1
                      ph_p_pds_003_2~tau_M*1
                      ph_p_pds_mf_2~tau_F*1
                      ph_p_pds_001_3~tau_S*1
                      ph_p_pds_002_3~tau_R*1
                      ph_p_pds_003_3~tau_M*1
                      ph_p_pds_mf_3~tau_F*1
                      ph_p_pds_001_4~tau_S*1
                      ph_p_pds_002_4~tau_R*1
                      ph_p_pds_003_4~tau_M*1
                      ph_p_pds_mf_4~tau_F*1
                      ph_p_pds_001_5~tau_S*1
                      ph_p_pds_002_5~tau_R*1
                      ph_p_pds_003_5~tau_M*1
                      ph_p_pds_mf_5~tau_F*1
                      ph_p_pds_001_6~tau_S*1
                      ph_p_pds_002_6~tau_R*1
                      ph_p_pds_003_6~tau_M*1
                      ph_p_pds_mf_6~tau_F*1"

lavaan(pu.4i.strong.invar,
  data = pub_yp_mean_wide.scaled,
  meanstructure = TRUE,
  estimator = "ML",
  missing = "fiml",
  ...
  saveRDS("p_4i_pub_strong.rds")
```

###### result

```{r}
eigen(inspect(readRDS("p_4i_pub_strong.rds"), "cor.lv"))$value

readRDS("p_4i_pub_strong.rds") %>%
  summary(
    std = T,
    fit.measures = TRUE,
    rsq = T
  ) %>%
  saveRDS("p_4i_pub_strong_result.rds")

readRDS("p_4i_pub_strong_result.rds")
```
...
```{r}
lg.4i.pub.strong.invar <- "#factor loadings
               pu_etaB =~ 1*ph_p_pds_001_0+
                          lambda_R*ph_p_pds_002_0+
                          lambda_M*ph_p_pds_003_0+
                          lambda_F*ph_p_pds_mf_0
...
lavaan(lg.4i.pub.strong.invar,
  ...
  saveRDS("lg_p_4i_pub_strong.rds")
```

###### result

```{r}
eigen(inspect(readRDS("lg_p_4i_pub_strong.rds"), "cor.lv"))$value

readRDS("lg_p_4i_pub_strong.rds") %>%
  summary(
    std = T,
    fit.measures = TRUE,
    rsq = T
  ) %>%
  saveRDS("lg_4i_pub_strong_result.rds")

readRDS("lg_4i_pub_strong_result.rds")
```

###### model fit (with qudratic)

```{r}
lg.4i.pub.strong.invar2 <- "#factor loadings
               pu_etaB =~ 1*ph_p_pds_001_0+
                          lambda_R*ph_p_pds_002_0+
                          lambda_M*ph_p_pds_003_0+
                          lambda_F*ph_p_pds_mf_0
...
lavaan(lg.4i.pub.strong.invar2,
  data = pub_yp_mean_wide.scaled,
  meanstructure = TRUE,
  estimator = "ML",
  missing = "fiml",
  ...
  saveRDS("lg_p_4i_pub_strong2.rds")
```

###### result

```{r}
eigen(inspect(readRDS("lg_p_4i_pub_strong2.rds"), "cor.lv"))$value

readRDS("lg_p_4i_pub_strong2.rds") %>%
  summary(
    std = T,
    fit.measures = TRUE,
    rsq = T
  ) %>%
  saveRDS("lg_4i_pub_strong_result2.rds")

readRDS("lg_4i_pub_strong_result2.rds")
```
...
lapply(
  c(
    "p_4i_pub_config_result.rds",
    "p_4i_pub_weak_result.rds",
    "p_4i_pub_strong_result.rds",
    "lg_4i_pub_strong_result.rds",
    "lg_4i_pub_strong_result2.rds"
  ),
  function(f) {
    readRDS(f)$fit[c(
      "chisq", "df", "pvalue",
...
lapply(
  c(
    ...
    "lgcm_pp_3t_result.rds",
    "lgcm_pc_7t_result.rds",
    "lgcm_Ext_7t_result.rds",
    "lgcm_Int_7t_result.rds",
    "lg_pub_strong_result2.rds"
  ),
  function(f) {
    readRDS(f)$fit[c(
  ...
  do.call(rbind, .) %>%
  round(3) %>%
  data.frame(model = c("g", "pp", "pc", "Ext", "Int", "pu"), ., row.names = NULL)
```
...
## Result summary from both models with and wthout puberty
...
### doFuture for Ext & Int model without sex

```{r}
EI_pga_pu_model_list <- c(
  Ext.pga_pu6.model,
  Int.pga_pu6.model
)

file_names <- c(
  "pgcm_Ext_pga_pu6_model.rds",
  "pgcm_Int_pga_pu6_model.rds"
)
...
foreach(a = 1:2, .options.future = list(seed = TRUE)) %dofuture% {
  EI_pga_pu_model_list[a] %>%
    lavaan(
      data = readRDS("pga6_all_data.rds"),
      meanstructure = TRUE,
      estimator = "ML",
    ...
    saveRDS(file_names[a])
}
```

### doFuture for Ext & Int model with sex

```{r}
EI_pga_pu_sex_model_list <- c(
  Ext.pga_pu6.sex.model,
  Int.pga_pu6.sex.model
)
